...
beautiful.init("/home/horhik/.config/awesome/themes/gruvbox/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "s", function () awful.spawn("flameshot gui")    end,
              {description = "open flameshot (make screenshot)", group = "launcher"}),
    ...
    -- Menubar
    awful.key({ modkey }, "p", function() awful.util.spawn("dmenu_run   -fn 'Mononoki Nerd Font:size=16' -nb '#282828' -nf '#d5c4a1' -sb '#3c3836' -sf '#ebdbb2' -c -l 20") end,
...
awful.key({ modkey}, "y", function()  beautiful.useless_gap = 30 end,
              {description = "show the dmenu", group = "launcher"})



-- AUTOSTART 
local ash = awful.spawn.with_shell
ash("enact --pos top")
ash("nitrogen --restore")
